...
(function () {
  ...
  var QA_GLOBAL = [
    { k: ["kost", "preis", "honorar s", "was zahle", "gebuhr", "teuer"], chip: "Was kostet mich das?",
      a: "Unsere Preise sind in allen Varianten gleich: <b>490&nbsp;&euro; einmalig</b> f&uuml;r die komplette Einrichtung, optional <b>290&nbsp;&euro;</b> f&uuml;r die neue Landingpage und <b>190&nbsp;&euro;/Monat</b> f&uuml;r die laufende Betreuung, monatlich k&uuml;ndbar. Dazu kommt Ihr Werbebudget (1.000, 1.500 oder 3.000&nbsp;&euro;/Monat), das Google direkt mit Ihnen abrechnet. Darauf nehmen wir <b>keine Provision</b>." },
    { k: ["variante", "unterschied", "paket", "welches", "empfehl"], chip: "Welche Variante passt zu mir?",
      a: "Die drei Varianten unterscheiden sich <b>nur im Werbebudget</b>. Unsere Leistung ist identisch. <b>Start</b> (1.000&nbsp;&euro;): vorsichtig testen, ca. 8&ndash;12 Auftr&auml;ge/Monat. <b>Wachstum</b> (1.500&nbsp;&euro;): unsere Empfehlung, ca. 12&ndash;18 Auftr&auml;ge, inkl. Umland. <b>Marktdominanz</b> (3.000&nbsp;&euro;): &uuml;berall ganz oben, 24&ndash;36 Auftr&auml;ge, braucht aber die Kapazit&auml;t daf&uuml;r. Sie k&ouml;nnen jederzeit wechseln, das ist keine Vertrags&auml;nderung." },
    { k: ["wer zahlt", "kostenlos", "versicherung zahlt", "249", "gegnerisch", "geschadigt"], chip: null,
      a: "Bei einem <b>unverschuldeten Unfall</b> zahlt die Versicherung des Unfallgegners das Gutachten. Das steht so im Gesetz (&sect;&nbsp;249 BGB). Ihr Kunde zahlt also nichts, Sie rechnen direkt mit der Versicherung ab. Wichtig: Es gilt ab ca. 1.000&nbsp;&euro; Schadenh&ouml;he und bei Teilschuld nur anteilig. Deshalb formulieren wir es in der Werbung mit Sternchen rechtssicher." },
    { k: ["kundig", "vertrag", "laufzeit", "binden", "aussteigen", "stoppen"], chip: "Kann ich jederzeit kündigen?",
      a: "Ja: <b>monatlich, formlos, ohne Begr&uuml;ndung</b>. Es gibt keine Mindestlaufzeit. Das Google-Ads-Konto samt allen Kampagnen l&auml;uft auf Ihren Namen und bleibt auch nach einer K&uuml;ndigung Ihr Eigentum. Das Werbebudget k&ouml;nnen Sie zus&auml;tzlich jederzeit am selben Tag pausieren lassen, zum Beispiel im Urlaub." },
    { k: ["ablauf", "wie lange", "wann", "erste anfrage", "erste lead", "los geht", "starten", "dauert", "weiter"], chip: "Wie geht es jetzt weiter?",
      a: "So l&auml;uft es: <b>1.</b> Sie w&auml;hlen Ihre Variante (formlos per Anruf oder WhatsApp). <b>2.</b> Woche 1&ndash;2: Wir bauen alles auf. Sie geben Anzeigen und Landingpage frei, bevor etwas live geht. <b>3.</b> Woche 3&ndash;6: Testphase, die ersten Anrufe kommen typischerweise in den ersten zwei Wochen nach Livegang. <b>4.</b> Ab Woche 7 wird mit echten Zahlen optimiert. Verl&auml;ssliche Kennzahlen haben wir nach ca. 6 Wochen." },
    { k: ["cpl", "pro anfrage", "pro lead", "lead kost"], chip: null,
      a: "<b>CPL</b> hei&szlig;t &bdquo;Cost per Lead&ldquo;: was eine Anfrage kostet (ein Anruf, eine WhatsApp oder ein ausgef&uuml;lltes Formular). Rechenbeispiel: Kostet ein Klick 5&nbsp;&euro; und ruft jeder zehnte Besucher an, kostet eine Anfrage 50&nbsp;&euro;. Unsere Erwartung f&uuml;r Sie: <b>42&ndash;63&nbsp;&euro; pro Anfrage</b>." },
    { k: ["cpa", "pro auftrag", "auftrag kost"], chip: null,
      a: "<b>CPA</b> hei&szlig;t &bdquo;Cost per Acquisition&ldquo;: was Sie ein gewonnener <b>Auftrag</b> insgesamt kostet (Werbebudget + unsere Betreuung, geteilt durch die Auftr&auml;ge). Unsere Erwartung: <b>ca. 90&ndash;150&nbsp;&euro; pro Auftrag</b>. Dem stehen laut BVSK-Tabelle 650&ndash;1.200&nbsp;&euro; Honorar gegen&uuml;ber. Deshalb rechnet sich das so deutlich." },
    { k: ["roas", "umsatz pro", "rendite", "lohnt sich", "rechnet sich"], chip: null,
      a: "<b>ROAS</b> = &bdquo;Return on Ad Spend&ldquo;: wie viel Umsatz jeder eingesetzte Euro zur&uuml;ckbringt. Beispiel: 1.690&nbsp;&euro; Gesamtkosten (Budget + Betreuung), 16.200&nbsp;&euro; Honorarumsatz = ROAS von 9,6. Selbst im vorsichtigsten Szenario liegt er bei gut 3. Die Kampagne tr&auml;gt sich also auch, wenn vieles schlechter l&auml;uft als geplant." },
    { k: ["impression share", "sichtbarkeit", "einblendung"], chip: null,
      a: "Der <b>Impression Share</b> sagt: Bei wie viel Prozent aller passenden Suchen wurde Ihre Anzeige tats&auml;chlich gezeigt? 70&nbsp;% hei&szlig;t: 7 von 10 Menschen, die in M&ouml;nchengladbach nach einem Gutachter suchen, sehen Sie. Je mehr Budget, desto h&ouml;her dieser Wert. Das ist der Haupt-Unterschied zwischen den drei Varianten." },
    { k: ["lead", "anfrage was"], chip: null,
      a: "Ein <b>Lead</b> ist eine echte Kontaktaufnahme: jemand ruft an, schreibt per WhatsApp oder f&uuml;llt das Formular aus. Noch kein Auftrag, aber bei Unfallgesch&auml;digten wird nach unserer Kalkulation etwa jeder zweite Lead zum Auftrag, weil die Menschen akut Hilfe brauchen." },
    ...
    { k: ["kontakt", "telefon", "erreich", "anrufen", "sprechen", "schippers", "singh", "mensch"], chip: null,
      a: "Sie erreichen uns direkt: <b>S&amp;S Connect GbR</b> (Schippers &amp; Singh), Nobelstra&szlig;e 3&ndash;5, 41189 M&ouml;nchengladbach. <a href='tel:+4915140322125'>+49 151 40322125</a> (anrufen oder WhatsApp). Wir gehen alles gerne pers&ouml;nlich mit Ihnen durch." },
    { k: ["landingpage", "warum neue seite", "eigene seite", "webseite"], chip: null,
      a: "Die <b>Landingpage</b> ist die Seite, auf der Besucher aus Ihrer Anzeige landen. Wir bauen daf&uuml;r eine eigene, aufs Anrufen optimierte Seite. Ihre normale Website hat zu viele Ausstiege (Men&uuml;, Unterseiten). Auf der Kampagnenseite gibt es genau ein Ziel: dass der Unfallgesch&auml;digte Sie sofort anruft oder Fotos per WhatsApp schickt. Den Entwurf k&ouml;nnen Sie hier im Portal ansehen." },
    { k: ["report", "tracking", "messen", "zahlen sehe", "kontrolle", "transparen"], chip: null,
      a: "Sie bekommen jeden Monat einen <b>Klartext-Report</b> mit den drei Zahlen, die z&auml;hlen: Wie viele Anfragen kamen, was hat eine Anfrage gekostet, was ein Auftrag. Dazu haben Sie jederzeit vollen Zugriff auf das Werbekonto. Nichts l&auml;uft im Verborgenen." },
    { k: ["budget wechseln", "budget andern", "erhohen", "verringern", "pausier", "urlaub"], chip: null,
      a: "Das Werbebudget ist <b>jederzeit anpassbar</b>: erh&ouml;hen, senken oder pausieren, auch tagesgenau (z.&nbsp;B. im Urlaub). Ein Wechsel zwischen den Varianten ist keine Vertrags&auml;nderung, sondern ein Anruf bei uns." },
    { k: ["risiko", "garantie", "sicher", "was wenn nicht", "funktioniert nicht", "verlust"], chip: null,
      a: "Ehrliche Antwort: Die Zahlen sind <b>Modellrechnungen</b>, keine Garantie. Jede Annahme steht offen in den Datenbl&auml;ttern. Ihre Absicherung: kleines Testbudget zum Start, monatlich k&uuml;ndbar, Budget-Stopp am selben Tag, und nach 6 Wochen echte Zahlen statt Prognosen. Die Analyse zeigt zudem: Selbst wenn Klickpreise oder Anrufquote 50&nbsp;% schlechter ausfallen, bleibt die Rechnung positiv." },
    { k: ["bvsk", "honorartabelle", "honorarbefragung"], chip: null,
      a: "Die <b>BVSK-Honorarbefragung</b> ist die offizielle Honorar-&Uuml;bersicht des Bundesverbands der KFZ-Sachverst&auml;ndigen, von Gerichten als Rechengrundlage anerkannt. Danach bringt ein Gutachten bei einem typischen 3.000-&euro;-Schaden ca. 650&ndash;750&nbsp;&euro; netto, bei gr&ouml;&szlig;eren Sch&auml;den bis 1.200&nbsp;&euro; und mehr. Das ist die Basis unserer gesamten Wirtschaftlichkeitsrechnung, gepr&uuml;ft gegen das Original-Dokument." },
    { k: ["konkurrenz", "wettbewerber", "petermann", "karpro", "unfallexpert", "kuban", "andere gutachter"], chip: null,
      a: "Vier Wettbewerber sind in M&ouml;nchengladbach aktiv: <b>Petermann</b> (stark bei Google-Treffern, 18 Stadt-Seiten), <b>KarPro</b> (gro&szlig;er Radius, verspricht 1&ndash;2&nbsp;h Reaktionszeit), <b>UnfallExpert24</b> (&uuml;berregional, wirbt mit Tankgutscheinen und zielt genau auf Rheydt) und <b>Kuban</b> (klassisches B&uuml;ro, ~3&nbsp;km von Ihnen). Ehrlich gesagt: Abschleppen, Mietwagen und Abwicklung <b>bewerben</b> auch Petermann und UnfallExpert24, laut deren Websites aber organisiert bzw. vermittelt. Ihr haltbares Argument: Bei Ihnen kommt alles aus dem <b>eigenen Haus</b> (eigene Flotte, eigene Werkstatt, Meisterbetrieb). Details im Datenblatt 4." },
    { k: ["google ads", "wie funktioniert werbung", "anzeige funktion", "adwords"], chip: null,
      a: "<b>Google Ads</b> funktioniert so: Wenn jemand nach einem KFZ-Gutachter in M&ouml;nchengladbach googelt, erscheint Ihre Anzeige ganz oben, noch &uuml;ber den normalen Treffern. Sie zahlen nur, wenn jemand tats&auml;chlich klickt (ca. 3&ndash;6&nbsp;&euro;). Da nach einem Unfall fast jeder sofort anruft statt lange zu vergleichen, ist das der direkteste Weg zu neuen Auftr&auml;gen." },
    { k: ["keyword", "suchbegriff"], chip: null,
      a: "<b>Keywords</b> sind die Suchbegriffe, bei denen Ihre Anzeige erscheinen soll, z.&nbsp;B. &bdquo;kfz gutachter m&ouml;nchengladbach&ldquo; oder &bdquo;unfallgutachten kosten&ldquo;. Wir haben &uuml;ber 80 passende Begriffe recherchiert und in Gruppen sortiert, inklusive einer Ausschlussliste, damit Ihr Budget nicht f&uuml;r Jobsuchende draufgeht." },
    { k: ["pdf", "download", "herunterladen", "ausdrucken", "dokument"], chip: null,
      a: "Alle Unterlagen gibt es doppelt: als Webseite hier im Portal (Startseite &rarr; &bdquo;Ihre Unterlagen&ldquo;) und als <b>PDF zum Herunterladen</b>. Der Download-Link steht bei jeder Dokument-Karte. Das Angebots-PDF k&ouml;nnen Sie direkt ausdrucken, ankreuzen und unterschreiben." },
    ...
    { k: ["smart bidding", "ziel-cpa", "automatisch biet", "algorithmus"], chip: null,
      a: "<b>Smart Bidding</b> hei&szlig;t: Nach der Testphase &uuml;bernimmt Googles Automatik das Bieten, mit einem von uns gesetzten Kosten-Limit pro Auftrag. Die Automatik lernt aus Ihren echten Anrufen und wird dadurch mit der Zeit g&uuml;nstiger. Daf&uuml;r braucht sie erst ca. 30&ndash;50 gemessene Anfragen." },
  ...
  var CFG = {
    index: {
      intro: "Willkommen! Ich zeige Ihnen in 2 Minuten, wo hier alles ist. Oder Sie fragen mich direkt. Womit starten wir?",
      ...
      tour: [
        ...
        { sel: "#idee", t: "Worum es geht", x: "Hier steht die Idee in 60 Sekunden. Falls Sie nur einen Absatz lesen wollen, dann diesen." },
        { sel: "#ablauf .timeline", t: "Ihr Fahrplan", x: "So l&auml;uft die Zusammenarbeit. Der orange Punkt zeigt: Sie sind gerade beim ersten Schritt: Unterlagen ansehen und Variante w&auml;hlen. Wichtig: Nichts geht live, bevor Sie es freigegeben haben." },
        ...
        { sel: "#varianten .plans", t: "Ihre einzige Entscheidung", x: "Drei Varianten: Der Unterschied ist nur, wie viel Werbebudget in den Markt geht. Die mittlere ist unsere Empfehlung. Wechseln geht sp&auml;ter jederzeit." },
        { sel: "#brauchen .need", t: "Was wir von Ihnen brauchen", x: "F&uuml;nf Punkte, zusammen etwa 20 Minuten. Punkt 1 ist der wichtigste: Ihre Varianten-Wahl. Formlos per Anruf oder WhatsApp gen&uuml;gt." },
        { sel: ".contact-card", t: "Direkter Draht", x: "Bei jeder Frage: einfach durchrufen. Und rechts unten finden Sie mich. Ich beantworte Fragen zu allem, was Sie hier sehen." }
      ]
    },
    marktanalyse: {
      intro: "Das ist die komplette Markt-Recherche. Ich f&uuml;hre Sie zu den wichtigsten Stellen oder beantworte direkt Ihre Fragen.",
      ...
      qa: [
        { k: ["wichtigste", "kurzfassung", "zusammenfassung", "tldr"], chip: null,
          a: "Das Wichtigste in drei S&auml;tzen: <b>1.</b> Ein Gutachten bringt Ihnen 650&ndash;1.200&nbsp;&euro;, ein Klick auf Ihre Anzeige kostet nur 3&ndash;6&nbsp;&euro;. Deshalb rechnet sich die Kampagne selbst im schlechten Fall. <b>2.</b> Vier Wettbewerber sind aktiv. Ihr haltbarer Trumpf: Rundum-Service aus dem <b>eigenen Haus</b> (eigene Flotte, eigene Werkstatt), w&auml;hrend die anderen so etwas laut Website organisieren oder vermitteln. <b>3.</b> Empfehlung: Start mit 1.500&nbsp;&euro;/Monat Werbebudget. Details: Kapitel 01 und 03." },
        { k: ["sicher sind die zahlen", "zahlen sicher", "verlasslich", "gepruft", "quellen", "stimmt das"], chip: null,
          a: "Jede tragende Aussage wurde von drei unabh&auml;ngigen Pr&uuml;finstanzen <b>gegengepr&uuml;ft</b>, mit dem Auftrag, sie zu widerlegen. Ergebnis: 22 best&auml;tigt, 3 widerlegt (die widerlegten Branchenzahlen sind im Dokument als Warnung markiert). Alles ist mit Quellen belegt (Kapitel 12). Kennzeichnung: gr&uuml;n = verifiziert, gelb = Sch&auml;tzung mit offenen Annahmen." },
        { k: ["rechner", "regler", "ausprobieren", "simulation"], chip: null,
          a: "In Kapitel 06 gibt es einen <b>Was-w&auml;re-wenn-Rechner</b>: Bewegen Sie die Regler f&uuml;r Budget, Klickpreis und Anrufquote. Alle Kennzahlen rechnen live mit. So sehen Sie selbst, wie robust die Rechnung ist." }
      ],
      tour: [
        { s: 1, sel: ".kpis", t: "Die Kernzahlen", x: "Honorar pro Gutachten, erwarteter Klickpreis, Ziel-Kosten pro Anfrage und das empfohlene Startbudget. Alles Weitere im Dokument begr&uuml;ndet diese vier Zahlen." },
        ...
        { sel: "#wettbewerb", t: "Ihre Konkurrenz", x: "Alle vier aktiven Wettbewerber, und zu jedem die passende Gegenstrategie mit Ihren vorhandenen St&auml;rken. Die Tabelle darunter zeigt ehrlich, wo Sie sich abheben und wo Wettbewerber &Auml;hnliches bewerben." },
        { sel: "#honorare", t: "Was ein Gutachten bringt", x: "Die offizielle Honorartabelle (BVSK 2024), gerichtlich anerkannt und von uns gegen das Original gepr&uuml;ft. Vorsicht: Viele Internetseiten zeigen hier falsche, zu niedrige Werte. Der rote Kasten erkl&auml;rt das." },
        { s: 1, sel: "#economics .calc", t: "Selbst ausprobieren", x: "Der Was-w&auml;re-wenn-Rechner: Regler bewegen und live sehen, was bei anderem Budget oder schlechterer Anrufquote passiert. Probieren Sie ruhig das Schlimmste aus. Die Rechnung h&auml;lt es aus." },
        ...
        { sel: "#quellen", t: "Alles belegt", x: "Methodik und Quellen: Jede Zahl ist nachvollziehbar. Gr&uuml;ne Markierung = gegen Prim&auml;rquelle verifiziert." }
      ]
    },
    angebot: {
      intro: "Das ist Ihr Angebot. Ich erkl&auml;re Ihnen gern jede Position oder f&uuml;hre Sie einmal durch.",
      ...
      tour: [
        { sel: ".addr-row", t: "Ihr Angebot", x: "Angebots-Nummer und G&uuml;ltigkeit stehen hier. Das Angebot gilt 30 Tage. Alle Preise verstehen sich zzgl. USt." },
        { s: 1, sel: ".plans", t: "Drei Varianten auf einen Blick", x: "Der schnelle &Uuml;berblick: Budget, erwartete Auftr&auml;ge, Gesamtkosten. Der Unterschied zwischen den Varianten ist nur das Werbebudget. Unsere Honorare sind &uuml;berall gleich." },
        ...
        { s: 1, sel: "#beauftragen", t: "Beauftragen: ein Klick", x: "Variante anklicken: WhatsApp &ouml;ffnet sich mit der fertigen Best&auml;tigung an uns, die Sie vor dem Absenden noch anpassen k&ouml;nnen. Lieber klassisch? PDF herunterladen, ankreuzen, unterschreiben." }
      ]
    },
    datenblaetter: {
      ...
      qa: [
        { k: ["wie lese", "lesen", "aufbau", "blatter"], chip: null,
          a: "Jedes Varianten-Blatt hat denselben Aufbau: oben die <b>vier Kennzahlen</b>, dann die <b>Budget-Verteilung</b> (wohin jeder Euro flie&szlig;t), die <b>Erwartung</b> in zwei Szenarien und (der ehrlichste Teil) <b>was dieses Budget kann und was nicht</b>. Legen Sie die Bl&auml;tter nebeneinander: Dieser Vergleich macht die Entscheidung meist von selbst." },
        { k: ["konkurrenz macht", "blatt 4", "budget taktik", "was macht die konkurrenz"], chip: null,
          a: "Blatt 4 sch&auml;tzt f&uuml;r jeden der vier Wettbewerber ein: seine Taktik, sein vermutetes Werbebudget und wie wir dagegen antreten. Ehrlich gekennzeichnet: Die Budget-Angaben sind <b>begr&uuml;ndete Einsch&auml;tzungen</b> (echte Werbeausgaben sind nicht &ouml;ffentlich). In den ersten vier Wochen ersetzen wir sie durch echte Auktionsdaten von Google." }
      ],
      tour: [
        { s: 1, sel: ".sheet:nth-of-type(1) .s-title-row", t: "Ein Blatt pro Variante", x: "Blatt 1 = Start, Blatt 2 = Wachstum (Empfehlung), Blatt 3 = Marktdominanz, Blatt 4 = Konkurrenz. Alle Varianten-Bl&auml;tter sind gleich aufgebaut, perfekt zum Nebeneinanderlegen." },
        { sel: ".sheet:nth-of-type(1) .kpis", t: "Kennzahlen oben", x: "Klicks, Anfragen, Auftr&auml;ge und der erwartete Umsatz, immer als ehrliche Spanne von vorsichtig bis realistisch." },
        ...
        { s: 1, sel: ".sheet:nth-of-type(1) .twocol", t: "Der ehrlichste Teil", x: "Was dieses Budget kann und was nicht: Wir schreiben Ihnen auch die Grenzen hin. Vergleichen Sie diesen Kasten &uuml;ber die drei Bl&auml;tter, dann wissen Sie, welche Variante passt." },
    ...
    landingpage: {
      intro: "Das ist der Entwurf Ihrer neuen Kampagnen-Seite: So sehen sie Unfallgesch&auml;digte nach dem Klick auf Ihre Anzeige. Ich zeige Ihnen, was wo ist und warum.",
      ...
      qa: [
        { k: ["warum diese seite", "warum landingpage", "zweck"], chip: null,
          a: "Diese Seite hat genau <b>einen Job</b>: dass ein Unfallgesch&auml;digter Sie sofort anruft. Deshalb: Telefonnummer immer sichtbar, WhatsApp als zweiter Weg, keine ablenkende Navigation. Ihre normale Website bleibt unver&auml;ndert. Das hier ist eine zus&auml;tzliche Seite nur f&uuml;r die Anzeigen-Besucher." },
        { k: ["sternchen", "warum kostenlos", "rechtssicher", "abmahn"], chip: null,
          a: "Das Sternchen ist Absicht und sch&uuml;tzt Sie: &bdquo;Kostenlos&ldquo; gilt rechtlich nur bei <b>unverschuldetem Unfall ab ca. 1.000&nbsp;&euro; Schaden</b>. Ohne diese Einschr&auml;nkung w&auml;re die Aussage abmahnbar (&sect;&nbsp;5 UWG). Es gab 2026 bereits ein Urteil in der Branche. Der Kasten &bdquo;Ehrlich gesagt&ldquo; erkl&auml;rt es dem Besucher transparent. Das schafft nebenbei Vertrauen." },
        { k: ["angepasst", "geandert", "fotos", "noch offen", "platzhalter"], chip: null,
          a: "Drei Dinge ersetzen wir vor dem Livegang: <b>1.</b> Die Beispiel-Fotos durch echte Bilder aus Ihrem Betrieb. <b>2.</b> Die Beispiel-Bewertungen durch Ihre echten Google-Rezensionen. <b>3.</b> Das Formular wird an Ihre E-Mail angeschlossen. Ihre Telefonnummern und &Ouml;ffnungszeiten sind bereits echt. Bitte einmal pr&uuml;fen." },
        { k: ["checkliste", "5 schritte", "unfall schritte"], chip: null,
          a: "Die 5-Schritte-Checkliste macht die Seite auch f&uuml;r Menschen n&uuml;tzlich, die noch vergleichen, und Schritt 5 f&uuml;hrt nat&uuml;rlich zu Ihnen. Nebeneffekt: Google stuft n&uuml;tzliche Seiten besser ein, das senkt Ihre Klickpreise." }
      ],
      tour: [
        { sel: ".top-call", t: "Anruf: immer erreichbar", x: "Die Nummer klebt oben und scrollt mit. Der gr&uuml;ne Punkt signalisiert: jetzt erreichbar. Ihr 24/7-Vorteil, prominent verpackt." },
        { s: 1, sel: ".h-cta", t: "Die zwei Wege zu Ihnen", x: "Anrufen oder Fotos per WhatsApp. Mehr Auswahl gibt es bewusst nicht. Auf dem Handy klebt zus&auml;tzlich eine Leiste mit beiden Buttons am unteren Rand." },
        { sel: ".usp", t: "Ihr st&auml;rkstes Argument", x: "Abschleppen, Gutachten in 24h, Mietwagen, komplette Abwicklung, und zwar aus Ihrem <b>eigenen Haus</b>, nicht &uuml;ber Vermittler wie bei den Wettbewerbern. Genau so formulieren wir es: ehrlich und abmahnsicher." },
        { s: 1, sel: "#kosten .pay-card", t: "Rechtssicher statt abmahnbar", x: "Der Kasten &bdquo;Ehrlich gesagt&ldquo;: Bagatellgrenze und Teilschuld werden offen erkl&auml;rt. Das sch&uuml;tzt Sie vor Abmahnungen und wirkt auf Kunden vertrauensw&uuml;rdiger als ein plattes Gratis-Versprechen." },
        { sel: "#checkliste .cl-grid", t: "N&uuml;tzlich sein gewinnt", x: "Die Unfall-Checkliste hilft dem Besucher sofort, und Schritt 5 ist der Anruf bei Ihnen. Google belohnt so etwas mit g&uuml;nstigeren Klickpreisen." },
        { sel: "#bewertungen .g-badge", t: "Ihre 4,9 Sterne", x: "Die Beispiel-Bewertungen ersetzen wir durch Ihre echten Google-Rezensionen. Daf&uuml;r brauchen wir nur den Link zu Ihrem Google-Profil." },
  ...
  var css = ""
    ...
    + ".kga-home{position:fixed;bottom:18px;left:18px;z-index:99970;display:inline-flex;align-items:center;gap:7px;background:rgba(15,23,32,.9);color:#EDF1F4;border:1px solid rgba(255,255,255,.2);border-radius:100px;padding:10px 18px;font:650 13px 'Segoe UI',system-ui,sans-serif;text-decoration:none;box-shadow:0 6px 22px rgba(0,0,0,.32);transition:transform .15s ease;backdrop-filter:blur(6px)}"
    + ".kga-home:hover{transform:translateY(-2px);background:rgba(15,23,32,1)}"
    + "body.kga-lp .kga-home{bottom:88px}@media(min-width:761px){body.kga-lp .kga-home{bottom:18px}}"
  ...
  function answer(q) {
    ...
    return "Gute Frage. Die beantworten wir Ihnen am liebsten pers&ouml;nlich: <a href='tel:+4915140322125'>+49&nbsp;151&nbsp;40322125</a> (Anruf oder WhatsApp, S&amp;S Connect). Oder probieren Sie eine der Fragen unten. Zu Kosten, Varianten, Ablauf und allen Begriffen habe ich die Antworten parat.";
  }
  function ask(q) {
  ...
  function startTour(force) {
    ...
    if (PAGE !== "index") {
      ...
      card.innerHTML =
        ...
        "<p>Ich zeige Ihnen, was auf dieser Seite wichtig ist. Sie entscheiden das Tempo.</p>" +
        "<div class='kga-choice'>" +
        "<button class='kga-prim kga-c-short'>&#9201; Wenig Zeit: nur das Wichtigste<small>" + kurz + " Stopps, ca. 30 Sekunden</small></button>" +
        "<button class='kga-c-full'>In Ruhe ansehen: kompletter Rundgang<small>" + full + " Stopps, ca. 2 Minuten</small></button>" +
        "</div>" +
